...
extern float Wheel_perimeter;                              // 轮子周长，单位：m
extern float Wheel_spacing;                                // 主动轮轮距，单位：m
extern float Axle_spacing;                                 // 小车前后轴的轴距，单位：m

extern Motor_parameter MOTOR_A, MOTOR_B, MOTOR_C, MOTOR_D; // 电机的参数结构体
