...
#define PKG_MICRO_ROS_RTTHREAD_PACKAGE_MAX_NODES 3
#define PKG_MICRO_ROS_RTTHREAD_PACKAGE_MAX_PUBLISHERS 5
#define PKG_MICRO_ROS_RTTHREAD_PACKAGE_MAX_SUBSCRIBERS 5
#define PKG_MICRO_ROS_RTTHREAD_PACKAGE_MAX_SERVICES 4
#define PKG_MICRO_ROS_RTTHREAD_PACKAGE_MAX_CLIENTS 4
